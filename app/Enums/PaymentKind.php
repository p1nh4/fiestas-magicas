 ...
 *
 * Implementa os contratos do Filament para que um `->options(PaymentKind::class)`
 * mostre a etiqueta traduzida e nao o nome do case em ingles.
 */
enum PaymentKind: string implements HasColor, HasLabel
{
    ...
    {
        return __('enums.payment_kind.' . $this->value);
    }
