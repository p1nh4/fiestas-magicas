 ...
 *
 * Implementa os contratos do Filament para que um `->options(CategoryKind::class)`
 * mostre a etiqueta traduzida e nao o nome do case em ingles.
 */
enum CategoryKind: string implements HasColor, HasLabel
{
    ...
    {
        return __('enums.category_kind.' . $this->value);
    }
